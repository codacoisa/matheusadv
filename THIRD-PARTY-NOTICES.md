...
| --- | --- | --- | --- |
| [ranuts/document](https://github.com/ranuts/document) | `fcaa66e` + `third_party/ranuts-document.patch` | Editor OnlyOffice local em iframe para DOCX, XLSX, PPTX e CSV | AGPL-3.0 — código-fonte mantido no submódulo, patch versionado no OfficeJur e licença copiada para os assets publicados |
