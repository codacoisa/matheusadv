...
| --- | --- | --- | --- |
| [ranuts/document](https://github.com/ranuts/document) | `90c3ca2672e998ee68073eaacf51246d676d8570` (OnlyOffice v9.3.0.133) + `third_party/ranuts-document.patch` | Editor OnlyOffice local em iframe para DOCX, XLSX, PPTX e CSV | AGPL-3.0 — código-fonte mantido no submódulo, patch versionado no OfficeJur e licença copiada para os assets publicados |
