...
Após o DataJud carregar classe e assuntos, o formulário oferece **Sugerir com IA**. A ação usa o LLM7.io em modo anônimo e envia somente área, classe e assuntos; o título determinístico continua disponível como fallback, a sugestão é editável e precisa ser conferida antes do salvamento. Não são enviados cliente, partes, CPF/CNPJ, número CNJ, observações ou movimentações.
