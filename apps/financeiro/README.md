...
Pessoas, clientes e casos possuem cadastros independentes. Uma pessoa física é cadastrada uma única vez e pode ser cliente diretamente ou representar uma ou mais pessoas jurídicas. O cliente pessoa jurídica possui razão social, CNPJ e dados próprios de contato e endereço, além de um ou vários representantes vinculados, com cargo, poderes, vigência e regra de assinatura. Um representante principal e ao menos um signatário são obrigatórios para clientes PJ. CPF e CNPJ não podem se repetir nos respectivos cadastros.
