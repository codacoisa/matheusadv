...
Após o DataJud carregar classe e assuntos, o formulário oferece **Sugerir com IA**. A ação usa o LLM7.io em modo anônimo e envia somente área, classe e assuntos; a sugestão precisa trazer uma melhoria real de redação, pode resumir um qualificador de procedimento, mas deve preservar a classe principal e os termos informativos de todos os assuntos. Quando o modelo de raciocínio esgota o limite sem produzir texto final, o módulo refaz a consulta com um limite maior. Respostas incompletas ou que apenas trocam separadores/pontuação são rejeitadas e o título determinístico atual é mantido. A sugestão aceita é editável e precisa ser conferida antes do salvamento. Não são enviados cliente, partes, CPF/CNPJ, número CNJ, observações ou movimentações.
