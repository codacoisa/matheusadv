(() => {
  ...
  function loadSettings() {
    ...
    try {
      ...
      return { ...defaults, ...syncState, ...globalSettings };
    } catch {
      return defaults;
    }
  }
  ...
  function saveSyncState() {
    ...
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        lastSyncSignature: settings.lastSyncSignature,
      }),
    );
    renderGistStatus();
  }
