const STORAGE_KEY = 'officejur::documentos::hipossuficiencia::draft';
...
const normalizeFilename = value => window.OfficeJurDocumentUtils.normalizeFilename(value, 'hipossuficiencia');
