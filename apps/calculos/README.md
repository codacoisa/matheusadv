...
- catálogo de calculadoras, com pensão alimentícia ativa e demais matérias sinalizadas como futuras;
- assistente em quatro etapas;
- parcelas e abatimentos editáveis;
- INPC/IPCA consultados no SIDRA/IBGE;
...
- PDF detalhado com parâmetros, memória por lançamento, séries, fontes e hashes SHA-256.
